...
export default function ContactSection() {
  ...
  return (
    <section className="section" id="contact" style={{ flexDirection: 'column', gap: '3rem', paddingTop: '6rem', minHeight: '120vh' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '2rem', width: '100%', maxWidth: '900px', position: 'relative' }}>
        ...
        >
          ...
          >
            ...
            />
            <div>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.72rem', color: '#00d464', letterSpacing: '0.1em' }}>
                SIGNAL AVAILABLE
              </div>
              <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.8rem', color: 'rgba(232,244,253,0.5)', marginTop: '2px' }}>
      ...
      >
        © 2024 ALEX NOVA · BUILT IN ZERO GRAVITY · EVENT HORIZON REACHED
      </motion.div>
    </section>
  );
}
